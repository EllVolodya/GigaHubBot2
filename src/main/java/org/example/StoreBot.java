    ...
    private void handleState(Long userId, String chatId, String text, String state, Update update) {
        ...
        switch (state) {
            ...
            case "order_pickup" -> {
                ...
                // Формуємо текстовий список товарів у форматі Назва:Ціна;
                ...
                try (Connection conn = DatabaseManager.getConnection()) {
                    ...
                    try (PreparedStatement stmt = conn.prepareStatement(sql)) {
                        ...
                        stmt.setString(10, itemsDb.toString());
                        stmt.executeUpdate();
                    }
                } catch (SQLException e) {
                    e.printStackTrace();
            ...
            case "awaiting_city_delivery" -> {
                ...
                // Дані користувача: Адреса, П.І., Телефон, Картка
            ...
            case "awaiting_post_delivery" -> {
                ...
                // Дані користувача: Відділення НП, П.І., Телефон, Картка
                String[] parts = text.split(",", 4);
