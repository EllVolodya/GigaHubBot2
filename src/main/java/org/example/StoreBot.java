...
public class StoreBot extends TelegramLongPollingBot {
    ...
    //Права
    private final List<Long> ADMINS = List.of(533570832L,1030917576L);
    private final List<Long> DEVELOPERS = List.of(533570832L, 1030917576L); // тут айді розробників
    ...
    private void showAdminOrder(Long adminId, String chatId) {
        ...
        if (orders == null || orders.isEmpty()) {
            sendText(chatId, "У цього користувача замовлень немає.");
            return;
        }
